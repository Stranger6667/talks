...
```python
cache_redis = StrictRedis.from_url(BaseSettings.REDIS_CACHE_LOCAL_URL, **BaseSettings.REDIS_CACHE_LOCAL_TIMEOUT)
```

@snap[south]
<b style="font-size:20px;">4.3</b>
@snapend
